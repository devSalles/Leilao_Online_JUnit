...
//    }
    ...
    @ExceptionHandler(UsuarioNaoProprietarioException.class)
    public ResponseEntity<MessageRestError> UsuarioNaoProprietarioException(UsuarioNaoProprietarioException ex)
    {
        MessageRestError messageRestError = new MessageRestError(HttpStatus.BAD_REQUEST,ex.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(messageRestError);
    }
